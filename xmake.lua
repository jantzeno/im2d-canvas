...
target("im2d_import")
    ...
    add_deps("im2d_canvas", "im2d_logging", "vendor_lunasvg", "vendor_libdxfrw")
...
target("svg_demo")
    ...
    set_default(true)
    set_rundir("$(projectdir)")
    add_files("src/demo/demo_app.cpp", "src/demo/demo_imported_artwork_windows.cpp", "src/demo/demo_sample_browser.cpp", "src/demo/svg_demo.cpp")
    add_deps("im2d_canvas", "im2d_import", "im2d_logging")
    add_packages("libsdl3", "glad", "imgui")
...
target("dxf_demo")
    ...
    set_default(true)
    set_rundir("$(projectdir)")
    add_files("src/demo/demo_app.cpp", "src/demo/demo_imported_artwork_windows.cpp", "src/demo/demo_sample_browser.cpp", "src/demo/dxf_demo.cpp")
    add_deps("im2d_canvas", "im2d_import", "im2d_logging")
    add_packages("libsdl3", "glad", "imgui")
